...
type SvgAttribute<T extends SvgElementType> = BSvgAttribute<T> &
  React.AriaAttributes &
  DataAttr;

type SvgEffectAttr<T extends SvgElementType> =
  | (OrFun<SvgAttribute<T>> & StyleProps & BSvgEvent<T>)
...
type SvgCreater<key extends SvgElementType> = NodeCreater<
  key,
  SvgElement<key>,
  SvgEffectAttr<key>
>;

    ...
    components: [
      {
        ...
        name: 'Switch 开关',
        description: '开关选择器',
        showcase: () => import('./advanced/switch-showcase'),
        status: 'stable',
      },
      {
        id: 'tag',
        name: 'Tag 标签',
        description: '标记和分类',
        showcase: () => import('./advanced/tag-showcase'),
        status: 'stable',
      },
      {
        id: 'avatar',
        name: 'Avatar 头像',
        description: '用户头像展示',
        showcase: () => import('./advanced/avatar-showcase'),
        status: 'stable',
      },
      {
        id: 'rating',
        name: 'Rating 评分',
        description: '评分组件',
        showcase: () => import('./advanced/rating-showcase'),
        status: 'stable',
      },
      {
        id: 'skeleton',
        name: 'Skeleton 骨架屏',
        description: '加载占位符',
        showcase: () => import('./advanced/skeleton-showcase'),
        status: 'stable',
      },
    ],
  },

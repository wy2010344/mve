...
export default function (date: StoreRef<YearMonthDayVirtualView>) {
  ...
  fdom.div({
    ...
    children() {
      ...
      fdom.div({
        className:
          'w-full h-11 flex justify-between items-center [padding-inline:18px] bg-base-100 z-10',
        children() {
          fdom.div({
              ...
              fdom.h1({
                ...
                children() {
                  ...
                  if (today().year != d.year) {
                    return `${d.year}-${numberIntFillWithN0(
                      d.month,
                      2
                    )}-${numberIntFillWithN0(d.day, 2)}`;
                  }
                  return `${numberIntFillWithN0(
                    d.month,
                    2
                  )}-${numberIntFillWithN0(d.day, 2)}`;
                },

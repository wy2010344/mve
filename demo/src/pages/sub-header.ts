...
export default function (selectedDemo: {
  ...
  const { theme, toggleTheme, themeColors, addNotification, getNotifications } = gContext.consume()
  fdom.div({
          ...
          fdom.div({
            ...
            children() {
              fdom.button({
                ...
                className: "inline-flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl transition-all duration-200 hover:scale-105",
                children() {
                  fdom.span({
                    className: "text-lg",
                    childrenType: "text",
                      ...
                      renderIf(
                        ...
                        () => {
                          fdom.span({
                            ...
                            childrenType: "text",
                            children() {
                              return Math.min(getNotifications().length, 9).toString();
                            }
                          });
                        }
                      );

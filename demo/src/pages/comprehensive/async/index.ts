...
export default function () {
  ...
  const { getUserData, userLoading, getTasksData, tasksLoading } = comprehensiveContext.consume();
      ...
      fdom.div({
        ...
        children() {
          ...
          fdom.p({
            ...
            childrenType: "text",
            children: "hookPromiseSignal 的正确使用方式，直接在属性中使用 get 函数"
          });
        }
      });
                  ...
                  renderOne(getUserData, function (result) {
                    if (result?.type === 'success') {
                      ...
                      fdom.div({
                        ...
                        children() {
                          fdom.div({
                            className: "w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full mx-auto mb-4 flex items-center justify-center text-2xl text-white",
                            childrenType: "text",
                  ...
                  renderIf(
                    ...
                    () => {
                      fdom.div({
                        ...
                        children() {
                          fdom.div({
                            className: "animate-spin w-8 h-8 border-4 border-green-500 border-t-transparent rounded-full mx-auto mb-2"
                          });
                          fdom.p({
                            childrenType: "text",
                            children: "加载任务数据中..."

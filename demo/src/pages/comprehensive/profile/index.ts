...
export default function () {
  ...
  const { getUserData, userLoading, taskStats } =
        ...
        if (o?.type == 'success') {
          ...
          fdom.div({
            ...
            children() {
              fdom.div({
                className:
                  'w-24 h-24 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full mx-auto mb-6 flex items-center justify-center text-4xl text-white',
                childrenType: 'text',

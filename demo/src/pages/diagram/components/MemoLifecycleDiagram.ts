            ...
            children() {
              ...
              fdom.div({
                ...
                children() {
                  ...
                  fdom.div({
                    className:
                      'p-4 bg-blue-50 rounded-lg border-l-4 border-blue-400',
                    children() {
                      fdom.div({
                  ...
                  fdom.div({
                    className:
                      'p-4 bg-green-50 rounded-lg border-l-4 border-green-400',
                    children() {
                      fdom.div({
                  ...
                  fdom.div({
                    className:
                      'p-4 bg-red-50 rounded-lg border-l-4 border-red-400',
                    children() {
                      fdom.div({
            ...
            children() {
              ...
              fdom.div({
                ...
                children() {
                  ...
                  fdom.div({
                    className:
                      'p-4 bg-yellow-50 rounded-lg border-l-4 border-yellow-400',
                    children() {
                      fdom.div({
                  ...
                  fdom.div({
                    className:
                      'p-4 bg-purple-50 rounded-lg border-l-4 border-purple-400',
                    children() {
                      fdom.div({

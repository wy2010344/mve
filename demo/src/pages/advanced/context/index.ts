...
export default function () {
  const { theme, themeColors, toggleTheme, addNotification } =
    gContext.consume();
        ...
        fdom.div({
          ...
          children() {
            fdom.button({
              onClick: toggleTheme,
              className:
                'px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg font-medium hover:shadow-lg transition-all duration-200',
              childrenType: 'text',
              children: '切换主题',
            });

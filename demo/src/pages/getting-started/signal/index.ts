              ...
              fdom.div({
                ...
                children() {
                  ...
                  fdom.button({
                    onClick: reset,
                    className() {
                      return `px-4 py-2 rounded-lg font-medium transition-colors duration-200 ${isDark ? "bg-gray-600 hover:bg-gray-500 text-white" : "bg-gray-500 hover:bg-gray-600 text-white"
                        }`;
                    },
                    childrenType: "text",
                    children: "🔄"
              ...
              fdom.div({
                ...
                children() {
                  ...
                  fdom.input({
                    ...
                    className() {
                      return `px-4 py-2 border rounded-lg text-center focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200 ${isDark

      ...
      fdom.div({
        ...
        children() {
          ...
          fdom.p({
            ...
            childrenType: 'text',
            children:
              'MVE 提供三套 DOM API：dom（链式）、fdom（扁平）、zdom（性能优化）',
          });
        },
      });
              ...
              children() {
                fdom.div({
                  ...
                  children() {
                    ...
                    fdom.code({
                      className() {
                        return `px-2 py-1 rounded text-sm font-mono ${
                          isDark
                  ...
                  className() {
                    return `${
                      isDark
                        ...
                        : 'bg-gray-100 text-gray-800'
                    } p-4 rounded-lg overflow-x-auto text-xs`;
                  },
                  childrenType: 'text',
            ...
            children() {
              renderArrayKey(
                ...
                getItem => {
                  fdom.div({
                    className() {
                      return `flex items-center gap-3 p-3 rounded-lg transition-colors duration-200 ${
                    ...
                    children() {
                      ...
                      fdom.span({
                        className() {
                          return `flex-1 ${
                            getItem().done ? 'line-through text-gray-500' : ''
                          }`;
                        },
                        childrenType: 'text',
                        children() {

...
import { emptyFun, emptyObject, genTemplateStringS2, genTemplateStringS1, objectDiffDeleteKey, VType, vTypeisGetValue, trackSignal } from "wy-helper"
import { domTagNames } from "wy-dom-helper"
import { hookBuildChildren } from "./hookChildren"
import { hookAddResult, hookTrackSignal } from "./cache"
 ...
 * 动态的
 */
type DomEffectAttr<T extends DomElementType> = (BDomAttribute<T> & React.DOMAttributes<DomElement<T>>) | (() => BDomAttribute<T>)

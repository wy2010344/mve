define(["require", "exports"], function (require, exports) {
    ...
    exports.ageFromPid = exports.sexFromPid = exports.birthdayFromPid = exports.validatePid = void 0;
    /**
     * 验证身份证
     * @param code
     */
    ...
    exports.birthdayFromPid = birthdayFromPid;
    /**
     * 获得性别
     * 1代表男性，0代表女性
     * @param ic
     */
    function sexFromPid(ic) {
        if (ic.length == 15) {
    ...
    exports.sexFromPid = sexFromPid;
    /**
     * 身份证获得号码
     * @param identityCard
     */
    function ageFromPid(identityCard) {
        //时间字符串里，必须是“/”
